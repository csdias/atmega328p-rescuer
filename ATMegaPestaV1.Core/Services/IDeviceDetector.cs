...
/// <summary>
/// What the USB scan found on the bench. These are the two devices that have to be present
...
{
    /// <summary>The bench has everything it needs to proceed.</summary>
    public bool Complete => Ch340Port is not null && UsbAspConnected;

    /// <summary>A bench where nothing showed up — the starting state of a failed scan.</summary>
    public static DetectedDevices None => new(null, false);
}

/// <summary>
/// Scans the USB for the bench's hardware. This is the first step at startup: until it
